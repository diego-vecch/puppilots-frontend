...
export function HomeSection (): JSX.Element {
  return (
    <section className='max-w-7xl overflow-hidden w-full relative md:h-full flex flex-col gap-20'>
      <div className='px-2 flex flex-col py-20 md:py-60 font-lato text-xl justify-center items-center'>
        ...
        <div className='py-8'><h3 className=' text-pup-text_w_3 text-2xl font-lato'>Disponible en Argentina, Chile, Colombia y Perú </h3>
        </div>
      </div>
